...
public partial class LabCalculatorBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ILabCalculatorVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by the <c>UnaryPExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitUnaryPExpr([NotNull] LabCalculatorParser.UnaryPExprContext context) { return VisitChildren(context); }
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitMmaxMminExpr([NotNull] LabCalculatorParser.MmaxMminExprContext context) { return VisitChildren(context); }
	...
	/// <summary>
	/// Visit a parse tree produced by the <c>UnaryMExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitUnaryMExpr([NotNull] LabCalculatorParser.UnaryMExprContext context) { return VisitChildren(context); }
