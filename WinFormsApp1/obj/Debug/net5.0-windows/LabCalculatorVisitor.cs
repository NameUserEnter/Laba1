...
public interface ILabCalculatorVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitUnaryPExpr([NotNull] LabCalculatorParser.UnaryPExprContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitMmaxMminExpr([NotNull] LabCalculatorParser.MmaxMminExprContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitUnaryMExpr([NotNull] LabCalculatorParser.UnaryMExprContext context);
